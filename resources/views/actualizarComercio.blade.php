    ...
    <div class="agileinfo-grap">
        <div class="agileits-box">
            <header class="agileits-box-header clearfix">
                <h3>ACTUALIZAR COMERCIO - {{ $comercio->nombre }}</h3>
                <!--grid-->
                <div class="validation-system">
                    ...
                    <div class="validation-form">
                        ...
                        <form action="{{ route('actualizarComercio') }}" method="POST" enctype="multipart/form-data">
                            {!! csrf_field() !!}
                            ...
                            <div class="vali-form">
                                <div class="col-md-6 form-group2">
                                    ...
                                    <select for="tipoPersona" name="tipoPersona" required="">
                                        <option selected="" value="{{$comercio->tipoPersona}}">{{$comercio->tipoPersona}} </option>
                                ...
                                <div class="col-md-6 form-group1 form-last">
                                    ...
                                    <input type="text" placeholder="CC o NIT" required="" name="nit" value="{{ $comercio->nit }}">
                                </div>
                            </div>
                            <div class="vali-form">    
                                <div class="col-md-6 form-group1">
                                    <label class="control-label">Nombre del Establecimiento</label>
                                    <input type="text" placeholder="Nombre del Establecimiento" required="" name="nombreEstablecimiento" value="{{ $comercio->nombre }}">
                                 </div>   
                               
                            
                                <div class="col-md-6 form-group1 form-last">
                                    <label class="control-label">Dirección del Notificaciones</label>
                                    <input type="text" placeholder="Dirección del Notificaciones" required="" name="dirNotificaciones" value="{{$comercio->dirNotificaciones}}">
                                 </div>   
                            ...
                            <div class="vali-form"> 
                                <div class="col-md-6 form-group1 ">
                                    ...
                                    <input type="text" placeholder="Dirección del Establecimiento" required="" name="dirEstablecimiento" value="{{$comercio->dirEstablecimiento}}">
                                </div>   
                                <div class="col-md-6 form-group2 form-last">
                                    <label class="control-label">Barrio</label>
                                    <select name="barrio" for="barrio" required="">
                                        <option selected="" value="{{$comercio->barrio}}">{{$comercio->barrio}} </option>
                                        <option for="barrio" value="Barrio 1" >Barrio 1 </option>
                                        <option for="barrio" value="Barrio 2" >Barrio 2 </option>
                                        <option for="barrio" value="Barrio 3" >Barrio 3 </option>
                                        <option for="barrio" value="Barrio 4" >Barrio 4 </option>
                             ...
                             <div class="vali-form">
                                <div class="col-md-6 form-group1 ">
                                    ...
                                    <input type="text" placeholder="Teléfono Fijo" name="telefono" value="{{$comercio->telefono}}">
                                </div>
                                <div class="col-md-6 form-group1 form-last">
                                    <label class="control-label">Celular</label>
                                    <input type="text" placeholder="Celular" name="celular" value="{{$comercio->celular}}">
                                </div>
                            ...
                            <div class="vali-form">
                                ...
                                <div class="col-md-6 form-group2 group-mail">
                                    ...
                                    <select name="actComercial" for="actComercial" required="">
                                        <option selected="" value="{{$comercio->actComercial}}">{{$comercio->actComercial}} </option>
                                ...
                                <div class="col-md-6 form-group2 group-mail">
                                    ...
                                    <select name="categoria" for="categoria" required="">
                                        <option selected="" value="{{$comercio->categoria}}">{{$comercio->categoria}} </option>
                            ...
                            <div class="vali-form"> 
                                <div class="col-md-6 form-group2">
                                    ...
                                    <select name="viaPrincipal" for="viaPrincipal" required="">
                                        <option selected="" value="{{$comercio->viaPrincipal}}">{{$comercio->viaPrincipal}} </option>
                                ...
                                <div class="col-md-6 form-group2 form-last">
                                    ...
                                    <select name="duenoTrabaja" for="duenoTrabaja" required="">
                                        <option selected="" value="{{$comercio->duenoTrabaja}}">{{$comercio->duenoTrabaja}} </option>
                            ...
                            <div class="vali-form">
                                  <div class="col-md-6 form-group1 ">
                                    ...
                                    <input type="text" placeholder="Horario de atención al público" name="horario">
                                </div>
                                <div class="col-md-6 form-group2 form-last">
                                    <label class="control-label">Tipo de local</label>
                                    <select name="tipoLocal" for="tipoLocal" required="">
                                        <option selected="" value="{{$comercio->tipoLocal}}">{{$comercio->tipoLocal}} </option>
                            ...
                            <div class="vali-form">
                                <div class="col-md-6 form-group1 ">
                                    ...
                                    <input type="text" placeholder="Cantidad de trabajadores" name="cantTrabajadores" value="{{$comercio->cantTrabajadores}}">
                                </div>
                                <div class="col-md-6 form-group1 ">
                                    <label class="control-label">Área total del establecimiento</label>
                                    <input type="text" placeholder="Área total del establecimiento" name="areaLocal" value="{{$comercio->areaLocal}}">
                                </div>
                            ...
                            <div class="vali-form">
                                  <div class="col-md-6 form-group1 ">
                                    ...
                                    <input type="text" placeholder="Ventas promedio mensuales" name="ventasPromedio" value="{{$comercio->ventasPromedio}}">
                                </div>
                                <div class="col-md-6 form-group2 form-last">
                                    <label class="control-label">¿Tiene instalados avisos y tableros?</label>
                                    <select name="avisos" for="avisos" required="">
                                        <option selected="" value="{{$comercio->avisos}}">{{$comercio->avisos}} </option>
                            ...
                            <div class="vali-form">
                                <div class="col-md-6 form-group1">
                                    ...
                                    <input type="date" name="inicioActividades" value="{{$comercio->inicioActividades}}">
                                </div>
                                <div class="col-md-6 form-group2">
                                 <label class="control-label">Consumo de Energía</label>
                                    <select name="consumoEnergia" for="consumoEnergia" required="">
                                        <option selected="" value="{{$comercio->consumoEnergia}}">{{$comercio->consumoEnergia}} </option>
                            ...
                            <div class="vali-form">
                                <div class="col-md-6 form-group1">
                                    ...
                                    <input type="text" placeholder="Nombre" required="" name="nombreRepresentante" value="{{$comercio->nombreRepresentante}}">
                                 </div>   
                               
                            
                                <div class="col-md-6 form-group1 form-last">
                                    <label class="control-label">Cédula de Ciudadania</label>
                                    <input type="text" placeholder="Cédula de Ciudadania" required="" name="cc" value="{{$comercio->cc}}">
                                 </div>   
                            ...
                            <div class="vali-form"> 
                                <div class="col-md-6 form-group1 ">
                                    ...
                                    <input type="text" placeholder="Dirección del Notificaciones" required="" name="dirNotificacionRep" value="{{$comercio->dirNotificacionRep}}">
                                </div>   
                                <div class="col-md-6 form-group2 form-last">
                                    <label class="control-label">Nivel de Estudios</label>
                                    <select name="nivelEstudio" for="nivelEstudio" required="">
                                        <option selected="" value="{{$comercio->nivelEstudio}}">{{$comercio->nivelEstudio}} </option>
                            ...
                            <div class="vali-form">    
                                <div class="col-md-4 form-group1">
                                    <label class="control-label">Teléfono fijo</label>
                                    <input type="text" placeholder="Teléfono fijo" required="" name="telRepresentante" value="{{$comercio->telRepresentante}}">
                                 </div>   
                               
                            
                                <div class="col-md-4 form-group1 form-last">
                                    <label class="control-label">Celular</label>
                                    <input type="text" placeholder="Celular" required="" name="celRepresentante" value="{{$comercio->celRepresentante}}">
                                 </div>   
                                 <div class="col-md-4 form-group1 form-last">
                                    <label class="control-label">Whatsapp</label>
                                    <input type="text" placeholder="Whatsapp" required="" name="waRepresentante" value="{{$comercio->waRepresentante}}">
                                 </div>   
                                 <div class="clearfix"> </div>
                            </div>   
                            ...
                            <div class="vali-form">
                                <div class="col-md-6 form-group1">
                                    ...
                                    <input type="text" placeholder="Facebook"  name="facebook" value="{{$comercio->facebook}}">
                                </div>
                                <div class="col-md-6 form-group1 form-last">
                                    <label class="control-label">Twitter</label>
                                    <input type="text" placeholder="Twitter" name="twitter" value="{{$comercio->twitter}}">
                                </div>
                                <div class="clearfix"> </div>
                            </div>
                            <div class="vali-form vali-form1">
                                <div class="col-md-6 form-group1">
                                    ...
                                    <input type="text" placeholder="Instagram" name="instagram" value="{{$comercio->instagram}}">
                                </div>
                                <div class="col-md-6 form-group1 form-last">
                                    <label class="control-label">Website</label>
                                    <input type="text" placeholder="URL" name="url" value="{{$comercio->url}}">
                                </div>
                                <div class="clearfix"> </div>
                            </div>
                            <div class="vali-form vali-form1">
                                <div class="col-md-6 form-group1">
                                    ...
                                    <input type="text" placeholder="Latitud" name="lat" required="" value="{{$comercio->lat}}">
                                </div>
                                <div class="col-md-6 form-group1 form-last">
                                    <label class="control-label">Longitud</label>
                                    <input type="text" placeholder="Longitud" name="long" required="" value="{{$comercio->long}}">
                                </div>
                            ...
                            <div class="vali-form vali-form1">
                                <div class="col-md-6 form-group1">
                                    ...
                                    <input type="text" placeholder="Email" name="email" required="" value="{{$comercio->email}}">
                                </div>
                                <div class="clearfix"> </div>    
                            </div>
                            ...
                            <div class="vali-form">
                                <div class="col-md-6 form-group1">
                                    ...
                                    <div class="col-sm-8"><textarea name="descripcion" id="txtarea1" cols="50" rows="4" class="form-control1">{{$comercio->descripcion}}</textarea></div>
                                </div>
                            ...
                            <div class="vali-form"> 
                                <div class="col-md-6 form-group2">
                                    ...
                                    <select name="usaInternet" for="usaInternet" required="">
                                        ...
                                        <option for="usaInternet" value="0" >Nunca </option>
                                        <option for="usaInternet" value="1" >Una vez al mes </option>
                                        <option for="usaInternet" value="2" >Una vez cada 15 días </option>
                                        <option for="usaInternet" value="3" >Una vez a la semana </option>
                                        <option for="usaInternet" value="4" >Dos veces a la semana </option>
                                        <option for="usaInternet" value="5" >Todos los días </option>
                                    </select>
                                </div>
                                <div class="col-md-6 form-group2 form-last">
                                    ...
                                    <select name="usaEmail" for="usaEmail" required="">
                                        <option selected="" value=""> </option>
                                        <option for="usaEmail" value="0" >Nunca </option>
                                        <option for="usaEmail" value="1" >Una vez al mes </option>
                                        <option for="usaEmail" value="2" >Una vez cada 15 días </option>
                                        <option for="usaEmail" value="3" >Una vez a la semana </option>
                                        <option for="usaEmail" value="4" >Dos veces a la semana </option>
                                        <option for="usaEmail" value="5" >Todos los días </option>
                                    </select>
                                </div>
                            ...
                            <div class="vali-form"> 
                                <div class="col-md-6 form-group2">
                                    ...
                                    <select name="usaDrive" for="usaDrive" required="">
                                        <option selected="" value=""> </option>
                                        <option for="usaDrive" value="0" >Nunca </option>
                                        <option for="usaDrive" value="1" >Una vez al mes </option>
                                        <option for="usaDrive" value="2" >Una vez cada 15 días </option>
                                        <option for="usaDrive" value="3" >Una vez a la semana </option>
                                        <option for="usaDrive" value="4" >Dos veces a la semana </option>
                                        <option for="usaDrive" value="5" >Todos los días </option>
                                    </select>
                                </div>
                                <div class="col-md-6 form-group2 form-last">
                                    <label class="control-label">Facebook</label>
                                    <select name="usaFacebook" for="usaFacebook" required="">
                                        <option selected="" value=""> </option>
                                        <option for="usaFacebook" value="0" >Nunca </option>
                                        <option for="usaFacebook" value="1" >Una vez al mes </option>
                                        <option for="usaFacebook" value="2" >Una vez cada 15 días </option>
                                        <option for="usaFacebook" value="3" >Una vez a la semana </option>
                                        <option for="usaFacebook" value="4" >Dos veces a la semana </option>
                                        <option for="usaFacebook" value="5" >Todos los días </option>
                                    </select>
                                </div>
                            ...
                            <div class="vali-form"> 
                                <div class="col-md-6 form-group2">
                                    ...
                                    <select name="usaTwitter" for="usaTwitter" required="">
                                        <option selected="" value=""> </option>
                                        <option for="usaTwitter" value="0" >Nunca </option>
                                        <option for="usaTwitter" value="1" >Una vez al mes </option>
                                        <option for="usaTwitter" value="2" >Una vez cada 15 días </option>
                                        <option for="usaTwitter" value="3" >Una vez a la semana </option>
                                        <option for="usaTwitter" value="4" >Dos veces a la semana </option>
                                        <option for="usaTwitter" value="5" >Todos los días </option>
                                    </select>
                                </div>
                                <div class="col-md-6 form-group2 form-last">
                                    <label class="control-label">Instagram</label>
                                    <select name="usaInstagram" for="usaInstagram" required="">
                                        <option selected="" value=""> </option>
                                        <option for="usaInstagram" value="0" >Nunca </option>
                                        <option for="usaInstagram" value="1" >Una vez al mes </option>
                                        <option for="usaInstagram" value="2" >Una vez cada 15 días </option>
                                        <option for="usaInstagram" value="3" >Una vez a la semana </option>
                                        <option for="usaInstagram" value="4" >Dos veces a la semana </option>
                                        <option for="usaInstagram" value="5" >Todos los días </option>
                                    </select>
                                </div>
                            ...
                            <div class="vali-form"> 
                                <div class="col-md-6 form-group2">
                                    ...
                                    <select name="usaYoutube" for="usaYoutube" required="">
                                        <option selected="" value=""> </option>
                                        <option for="usaYoutube" value="0" >Nunca </option>
                                        <option for="usaYoutube" value="1" >Una vez al mes </option>
                                        <option for="usaYoutube" value="2" >Una vez cada 15 días </option>
                                        <option for="usaYoutube" value="3" >Una vez a la semana </option>
                                        <option for="usaYoutube" value="4" >Dos veces a la semana </option>
                                        <option for="usaYoutube" value="5" >Todos los días </option>
                                    </select>
                                </div>
                                <div class="col-md-6 form-group2 form-last">
                                    <label class="control-label">Whatsapp</label>
                                    <select name="usaWhatsapp" for="usaWhatsapp" required="">
                                        <option selected="" value=""> </option>
                                        <option for="usaWhatsapp" value="0" >Nunca </option>
                                        <option for="usaWhatsapp" value="1" >Una vez al mes </option>
                                        <option for="usaWhatsapp" value="2" >Una vez cada 15 días </option>
                                        <option for="usaWhatsapp" value="3" >Una vez a la semana </option>
                                        <option for="usaWhatsapp" value="4" >Dos veces a la semana </option>
                                        <option for="usaWhatsapp" value="5" >Todos los días </option>
                                    </select>
                                </div>
                            ...
                            <div class="vali-form"> 
                                <div class="col-md-6 form-group2">
                                    ...
                                    <select name="usaEditores" for="usaEditores" required="">
                                        <option selected="" value=""> </option>
                                        <option for="usaEditores" value="0" >Nunca </option>
                                        <option for="usaEditores" value="1" >Una vez al mes </option>
                                        <option for="usaEditores" value="2" >Una vez cada 15 días </option>
                                        <option for="usaEditores" value="3" >Una vez a la semana </option>
                                        <option for="usaEditores" value="4" >Dos veces a la semana </option>
                                        <option for="usaEditores" value="5" >Todos los días </option>
                                    </select>
                                </div>
                                <div class="col-md-6 form-group2 form-last">
                                    ...
                                    <select name="usaWord" for="usaWord" required="">
                                        <option selected="" value=""> </option>
                                        <option for="usaWord" value="0" >Nunca </option>
                                        <option for="usaWord" value="1" >Una vez al mes </option>
                                        <option for="usaWord" value="2" >Una vez cada 15 días </option>
                                        <option for="usaWord" value="3" >Una vez a la semana </option>
                                        <option for="usaWord" value="4" >Dos veces a la semana </option>
                                        <option for="usaWord" value="5" >Todos los días </option>
                                    </select>
                                </div>
                                   <div class="clearfix"> </div>
                            </div>
                            <div class="vali-form">
                                <div class="col-md-6 form-group2">
                                    ...
                                    <select name="inversionPublicidad" for="inversionPublicidad" required="">
                                        ...
                                        <option for="inversionPublicidad" value="1" >$ 50.000 </option>
                                        <option for="inversionPublicidad" value="2" >$ 100.000 </option>
                                        <option for="inversionPublicidad" value="3" >$ 100.000 + </option>
                                    </select>
                                </div>
                                 <div class="clearfix"> </div>
                            </div>
