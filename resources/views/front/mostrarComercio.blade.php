										...
										<div class="demo-grid">
											...
											<p align="left">
												...
												<form class="" action="{{route('mostrarUnico')}}" method="get">
													<input type="hidden" name="nit" value="{{$comercio->nit}}">
													<button type="submit" class="btn btn-primary">Ver Más <i class="fas fa-angle-right"></i></button>
												</form>
												<!-- <a href="{{route('mostrarUnico', $comercio->nit)}}" class="btn btn-primary">Ver Más <i class="fas fa-angle-right"></i></a> -->
												@endif
											<!--  -->
